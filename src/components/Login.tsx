...
const Login: FC = () => {
  ...
  return (
    <Link href={`${AUTH_ENDPOINT}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=${RESPONSE_TYPE}&scope=user-library-read streaming user-read-email user-read-private&state=STATE_STRING`}>
      Log in
    </Link>
